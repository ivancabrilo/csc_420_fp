...
from models import ResNet50Stage1, ResNet50Stage2
...
def parse_args():
    ...
    p.add_argument(
        "--out",
        type=str,
        default="../results/logs/res50_2gpu.txt",
    )
    return p.parse_args()
...
def main():
    ...
    print(f"ResNet-50 2-GPU pipeline: global_batch={args.global_batch}, "
    ...
    # build 2-stage model
    s1 = ResNet50Stage1().to(dev0)
    s2 = ResNet50Stage2().to(dev1)
