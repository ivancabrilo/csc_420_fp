...
from models import ResNet152Stage1_2, ResNet152Stage2_2
...
def parse_args():
    ...
    p.add_argument("--out", type=str,
                   default="../results/logs/res152_2gpu.txt")
    return p.parse_args()
...
def main():
    ...
    print(f"ResNet152 2-GPU pipeline: global_batch={args.global_batch}, "
    ...
    # Build 2-stage model
    stage1 = ResNet152Stage1_2().to(device0)
    stage2 = ResNet152Stage2_2().to(device1)
    ...
    # append so multiple runs end up in one file:
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            for x, y in train_loader:
                ...
                for xb, yb in zip(x_chunks, y_chunks):
                    ...
                    yb1 = yb.to(device1, non_blocking=True)

                    # Pipeline over 2 GPUs
                    h = stage1(xb0)          # GPU 0
                    out = stage2(h.to(device1))  # GPU 1
