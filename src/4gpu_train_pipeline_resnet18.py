...
def parse_args():
    ...
    p.add_argument("--out", type=str,
                   default="../results/logs/pipeline_4gpu.txt")
    return p.parse_args()
...
def main():
    ...
    print(f"4-GPU pipeline: global_batch={args.global_batch}, "
    ...
    #  4-stage model
    s1 = ResNet18Stage1_4().to(dev0)
    s2 = ResNet18Stage2_4().to(dev1)
    s3 = ResNet18Stage3_4().to(dev2)
    s4 = ResNet18Stage4_4().to(dev3)
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            for x, y in train_loader:
                ...
                for xb, yb in zip(x_chunks, y_chunks):
                    ...
                    loss = raw_loss / args.m      # gradient accumulation
                    loss.backward()
