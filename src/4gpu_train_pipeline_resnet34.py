...
def parse_args():
    ...
    p.add_argument("--out", type=str,
                   default="../results/logs/res34_4gpu.txt")
    return p.parse_args()
...
def main():
    ...
    print(f"ResNet-34 4-GPU pipeline: global_batch={args.global_batch}, "
    ...
    s1 = ResNet34Stage1_4().to(dev0)
    s2 = ResNet34Stage2_4().to(dev1)
    s3 = ResNet34Stage3_4().to(dev2)
    s4 = ResNet34Stage4_4().to(dev3)
